...
from deepdrive_zero.constants import USE_VOYAGE, VEHICLE_WIDTH, VEHICLE_LENGTH, CACHE_NUMBA
...
def get_vehicle_model(length):
    ...
    """
    front_axle, rear_axle, _, _ = get_vehicle_dimensions(length)
...
def test_bike_with_friction_step():
    vehicle_model = get_vehicle_model(VEHICLE_LENGTH)
