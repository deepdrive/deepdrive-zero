...
* Env steps per second is 2557: 
    ...
    Wall time: 445 µs
    ```
* 10 actions per second - with 60 physics steps per second allows for 2.5x faster learning. 75 meters in 1.5M steps for 60aps while in 600k steps for 10aps.
